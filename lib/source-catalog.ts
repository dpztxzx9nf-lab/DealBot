...
export const SOURCE_CATALOG: SourceCatalogEntry[] = [
  ...
  { id: "facebook_marketplace", name: "Facebook Marketplace", status: "placeholder_planned", scope: "local", layer: "local_marketplace", requiresCredentials: true, supportsMode: ["nearby", "hybrid"] },
  { id: "craigslist", name: "Craigslist", status: "placeholder_planned", scope: "local", layer: "local_marketplace", requiresCredentials: false, supportsMode: ["nearby", "hybrid"] },
  { id: "offerup", name: "OfferUp", status: "placeholder_planned", scope: "local", layer: "local_marketplace", requiresCredentials: true, supportsMode: ["nearby", "hybrid"] },
  ...
  { id: "walmart_clearance", name: "Walmart clearance", status: "needs_credentials", scope: "local", layer: "clearance", requiresCredentials: true, supportsMode: ["nearby", "hybrid"] },
  ...
  { id: "liquidation_auctions", name: "Liquidation and auction sources", status: "placeholder_planned", scope: "local", layer: "liquidation_auction", requiresCredentials: false, supportsMode: ["nearby", "hybrid"] },
